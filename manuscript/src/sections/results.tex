...
The operative temperature at which \ac{w} equals \ac{w-max} is a inversely proportional to the value of \ac{rh}.
...
Our results are in agreement with those obtained by \mycite{Rate2015} and those obtained by \mycite{Morris2019} when participants were exposed to \ac{t-db}~=~40~$^{\circ}$C and \ac{rh}~=~51~\%.
However, the \mycite{GaggeSET} also predicts that the use of electrical fans should be beneficial when \ac{t-db}~=~47~$^{\circ}$C and \ac{rh}~=~15~\%, however, these results are in disagreement with the experimental results of \mycite{Morris2019}.
We would like to remember to the reader that, as previously mentioned in the Introduction Section, the enthalpy of the air in \mycite{Morris2019} experiment was lower in the scenario with lower \ac{rh}.
...
Evaporative cooling technologies can, therefore, be used to reduce the value of \ac{t-db} and avoid heat strain.
...
An additional 33 million people would possibly avoid heat strain by simply elevating air speed up to 0.8~m/s.
