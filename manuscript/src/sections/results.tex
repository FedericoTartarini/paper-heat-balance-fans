...
\subsection{When Can Electric Fans be Used?}\label{subsec:use-fans}
...
The use of fans during heatwaves would be beneficial in the great majority of the locations worldwide with the exception of 29 locations where the use of \ac{v} higher than 0.8~m/s would be detrimental and 7 locations where elevated air movement is not recommended in any scenario.
...
However, the Gagge model also predicts that the use of electric fans should be beneficial when \ac{t-db}~=~47~$^{\circ}$C and \ac{rh}~=~15~\%. 
