...
% todo better describe sentence before
...
We also plotted the maximum extreme weather conditions recorded worldwide over the las 50 years.
...
Overall the use of fans would have been beneficial in most locations worldwide during extreme heat events.
Increasing, \ac{V} to 0.8~m/s and 4.5~m/s would have ensured that

% todo compare the above with the extreme temperatures recorded in each country
