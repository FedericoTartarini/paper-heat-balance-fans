...
\begin{figure}[thb!]
% todo SS maybe merge figure 5 and 6
    \centering
...
% todo schiavon: In this section I was hoping to find a direct, explicit and critical comparison between Jay and Gagge model, Gagge allows for the same temperature higher Rh im general (except lower RH). Is one better than other? Should we use Jay because is more conservative?
...
\begin{figure*}[thb!]
% todo SS I do not understand why you need the blue area and why you need to show the solid line and I would remove the solid line for v=0.2 m/s
    \centering
