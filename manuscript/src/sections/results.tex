...
We use a red shading to highlight the region in which electric fans should not be used, while we use a green background to depict when elevated air speed can be used to cool the human body.
...
Finally, Figure~\ref{fig:gagge_phs} compares the results obtained using the \mycite{GaggeSET} with those obtained using the \ac{phs}~\cite{iso7933}.
...
\begin{figure*}[hbt!]
    ...
    In the dark green region, the \mycite{GaggeSET} model estimates that while the use of fans is still beneficial, people are most likely to suffer from heat strain.}
    \label{fig:gagge_phs}
\end{figure*}
