...
It should be noted that \ac{v} is the average value of three air speeds measured at different heights over a period of at least three minutes.
...
It could be argued that some people during heatwaves may be wearing less clothes than what we assumed, hence, a value of \ac{clo} equal to 0.36 clo (i.e., walking shorts, short-sleeve shirt and sandals) would be more appropriate, however, we wanted to report more conservative results.
...
We assumed that during heatwaves \ac{t-db} and \ac{rh} indoors would be equal to \ac{t-db} and \ac{rh} outdoors.
Conditions indoors may, however, be slightly less severe than outdoors since the thermal mass would dump and shift peaks in outdoor temperature.
On the other hand, if the house is not shaded \ac{t-r} may rise significantly and worsen conditions indoors.
...
We did not show data from stations with a maximum temperature lower than 20~$^\circ$C\@.
