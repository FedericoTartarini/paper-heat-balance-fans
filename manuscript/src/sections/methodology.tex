...
In non uniform environments \ac{t-db} and \ac{v} are assumed to be equal to the average temperature and air speed measured at 0.1, 0.6, and 1.1~m above the ground for seated occupants and at 0.1, 1.1, and 1.7~m above the ground for standing occupants.
