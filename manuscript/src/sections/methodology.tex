...
A copy of the algorithm we used to calculate the results can also be found in Appendix~\ref{sec:python_code}.
...
A full list of the cities we included in the analysis is provided in the Appendix~\ref{sec:pop_weather}.
