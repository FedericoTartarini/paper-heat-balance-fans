...
% todo remove section about the elderly and limit the scope of this paper to young adults. There are more physiological data to support it, and we can still make a strong rationale that if lots of young people make the switch to fans then this could have a substantial effect on electricity use and help avoid the risk of blackouts for example.