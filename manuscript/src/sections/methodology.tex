...
One of the main differences between our proposed model and the one used by \mycite{Jay2015} is that their model does not accounts for heat stored in the core or the skin compartment.
...
These values are higher than those estimated by the \mycite{GaggeSET} model which are presented in Figure~\ref{fig:comparison_models}.
...
When available we selected the population of the urban agglomerate rather than of the city proper.
