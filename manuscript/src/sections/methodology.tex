...
Where \ac{v} is the average air speed of the flow that is used to cool the human body~\cite{Huang2014}.
...
Despite the fact that Equation~\ref{eq:latent-skin} is expressed as a function of \ac{w}, the human body does not regulates \ac{w} directly but, rather, it regulates the sweat rate.
Skin wettedness varies as a function of the activity of the sweat glands and the environmental conditions.
It correlates with warm discomfort and it is a good measure of thermal stress.
