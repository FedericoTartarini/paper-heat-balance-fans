...
In non uniform environments \ac{t-db} and \ac{v} are the average temperature and air speed measured at 0.1, 0.6, and 1.1~m above the ground for seated occupants and at 0.1, 1.1, and 1.7~m above the ground for standing occupants.
...
% todo check that all the equations exactly match the equations in the SET code
\begin{equation}
...
We are aware that this assumption has some limitations and may be inaccurate, however, we deemed to be an acceptable approximation since no other approach would have lead to better results.
One possible solution to this problem is simulating several building archetypes under different climatic conditions.
