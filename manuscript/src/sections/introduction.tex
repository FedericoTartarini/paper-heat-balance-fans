...
% todo should I remove the following sentence?
...
% note EA This is a very high power number for a few room fans.  I suspect [7] might be referring to whole-house (attic exhaust) fans, which are a different application.  Those are appropriate for removing interior heat gains, but much less efficient at direct occupant cooling.  They can of course be combined with ceiling fans for both forms of cooling.
...
% todo EA This is jump to a very different topic; probably should come under a new heading? And it's terrible practice to jump immediately deep into technical details of the model with no lead-in..
...
% note EA Need to describe how the model might have been incorporated in guidelines etc to solve the problems you have outlined so far in the paper.
%You can say that the model was too simple to be used for design, and that a new model is being proposed here to rectify that. All the details about M and wind speeds should go into a new background section about modeling, or into the next section, Methods...,
...
% todo cite .. [you could  citealso cite the ASHRAE Handbook of Fundamentals, which summarizes thisSET physiology well. It is useful because it is not an academic paper but part of the engineering profession's canon].
