...
% FT could you please share a couple of papers with me
...
% FT shall I remove the reference all together?
...
In addition, guidelines like those provided by Ready.gov, should not discourage people from using their electric fans based on the outdoor temperature but instead should set limits based on the environmental conditions indoors alone.
...
% FT could you please elaborate a bit more on this?
