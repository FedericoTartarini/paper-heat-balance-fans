...
\author[sinBerBest]{Federico Tartarini\corref{mycorrespondingauthor}\fnref{fn1}}
...
\fntext[fn1]{\textit{Postal address:} Berkeley Education Alliance for Research in Singapore (BEARS) Limited. 1 Create Way, \#11-01, CREATE Tower, Singapore 138602}
...
\begin{abstract}
    ...
    We developed a free, open-source, and easy-to-use online tool (\url{https://comfort.cbe.berkeley.edu}) to help researchers, building practitioners, and policymakers better understand under which conditions electric fans can be safely used to cool people.
\end{abstract}

\begin{keyword}
Resilience \sep Heat stress \sep Cooling \sep Air movement \sep Heat Strain \sep Open-source tool
\end{keyword}
